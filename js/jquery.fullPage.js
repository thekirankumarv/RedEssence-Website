  ...
  $.fn.fullpage = function (options) {
    ...
    $(".fp-section")
      ...
      .done(function () {
        ...
        if (
          options.menu &&
          options.css3 &&
          $(options.menu).closest(".fullpage-wrapper").length
        ) {
    ...
    function scrollHandler() {
      if (!options.autoScrolling) {
        ...
        var initial = Math.abs(
          currentScroll - $(".fp-section").first().offset().top
        );
          ...
          if (!isMoving) {
            $.isFunction(options.onLeave) &&
              options.onLeave.call(
                this,
                leavingSection,
                currentSection.index(".fp-section") + 1,
                yMovement
              );
    ...
    function getScrollSettings(v) {
      ...
      if (options.autoScrolling) {
        ...
        $(".section-image img:first").animate(
          { "margin-top": (-v.dtop / inaltime) * 407 },
          { queue: false, duration: 900, easing: "easeInOutCirc" }
        );
    ...
    function createInfiniteSections(v) {
      ...
      if (!v.isMovementUp) {
        ...
        $(".fp-section.active").after(
          v.activeSection.prevAll(".fp-section").get().reverse()
        );
      } else {
        // Scrolling up
    ...
    function landscapeScroll(slides, destiny) {
      ...
      if (options.css3) {
        ...
        addAnimation(
          slides.find(".fp-slidesContainer"),
    ...
    function addTableClass(element) {
      element
        .addClass("fp-table")
        .wrapInner(
          '<div class="fp-tableCell" style="height:' +
